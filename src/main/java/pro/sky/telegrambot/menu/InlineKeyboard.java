...
public class InlineKeyboard {
    ...
    //метод показывает стартовое меню
    ...
    /*метод показывает меню информацию о приюте*/
    ...
    /*данные метод необходим для имитация работы волонтера, после того как пользователь отправляет
