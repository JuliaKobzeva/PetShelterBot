...
public class TelegramBotUpdatesListener implements UpdatesListener {
            ...
            updates.forEach(update -> {
                ...
                try {
                    ...
                    if (update.message().text() != null) {
                        Handler textHandler = new TextHandler(telegramBot, contactDetailsService, ownerService, reportService);
    ...
    public void informOwner() {
        ...
        showInfoWhenFailedDeadline(reports);
     ...
     */
    private void showInfoWhenFailedDeadline(List<Report> reports) {
        ...
        reports.forEach(element -> {
            if (element.getDateOfLastReport().plusDays(1).equals(localDateTimeNow)) {
                ...
                telegramBot.execute(new SendMessage(VOLUNTEER_CHAT_ID, "Пользователь," +
                        " по имени: " + element.getOwner() + " id: " + element.getChatId() + " более двух суток не" +
